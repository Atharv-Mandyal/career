  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-xl bg-gradient-to-br from-primary/70 to-accent/30 dark:from-primary/80 dark:to-accent/60 p-6 flex flex-col justify-between text-primary-foreground lg:col-span-2">
          <div>
